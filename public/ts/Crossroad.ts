...
export default class Crossroad {
    ...
    public constructor(canvas: HTMLCanvasElement) {
        ...
        this.props = [
            new ImageProp(this.background.getWidth(), this.background.getYPos() + (this.background.getHeight() / 2), -(Game.randomInteger(1, 15) / 10), 0, this.background.getWidth() / 10, this.background.getHeight() / 5, './assets/img/players/fiets1.png')
        ]
